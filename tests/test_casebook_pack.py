"""Regression checks for the helix-sys-allocator-vault casebook."""
...
from casebook.harness import assert_expected, helix_sys_allocator_vault_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(helix_sys_allocator_vault_summary(), assert_expected())
